...
export default function AdminScrapeSitesSection({
  ...
  return (
    <div className="admin-card admin-sites-card">
      ...
      <AdminFormMessage>{siteFormMessage}</AdminFormMessage>
      <AdminFormMessage tone="error">{siteError}</AdminFormMessage>

      {siteLoading ? (
        <AdminInlineLoading message="Chargement des sites de collecte..." />
