    ...
    <div className="admin-content-grid admin-content-single">
      <section className="admin-analytics-column">
        <div className="admin-card admin-reports-card">
          ...
          <AdminFormMessage>{reportFormMessage}</AdminFormMessage>
          <AdminFormMessage tone="error">{reportError}</AdminFormMessage>

          {reportLoading ? (
            <AdminInlineLoading message="Chargement des réclamations..." />
